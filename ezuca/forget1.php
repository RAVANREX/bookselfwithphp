...
jQuery.validator.setDefaults({
    ...
    <form name="frm" id="frm" method="post" class="container" action="forget_code2.php">
							<table align="center" >
								<tr><td><b><u><h3>Enter New Password</h3></u></b>
									<td><input type="password" name="pass" id="pass" ><span id="invalid-pass"></span></td></tr>
									
                <tr><td><b><u><h3>Re-enter Your Password</h3></u></b>
                  <td><input type="password" name="rpass" id="rpass" ><span id="invalid-rpass"></span></td></td></tr>
<tr><td>&nbsp;</td><td><input type="submit" name="g" class="btn" value="submit"></td><td><h5 class="text-danger">
</h5></td></tr>
</table> </form>
