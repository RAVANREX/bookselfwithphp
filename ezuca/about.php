...
<head>
   ...
   <style type="text/css">/* Three image containers (use 25% for four, and 50% for two, etc) */
.column {
  float: left;
  width: 33.33%;
  padding: 5px;
...
<div class="header_image">
    ...
    <section>
      <div class="container"><div>
        <p><h3>Hi!</h3> we are<h5><b> Anirban sarkar</b></h5>&<h5><b> Suman saha </b></h5>the developer of this site. We have designed,developed this site in order of providing
        the best online learning experience with offering all the rights of authors to put forward their ideas and publish their ebook with ease.
      This platform will offer a huge variety of knowledge and can be accessible through every places.</p>
<br>
<p>===== WE ARE HAPPY TO SERVE YOU =====</p>
</div>
    </section>

        <marquee behavior="scroll" direction="left" loop="" height="200"  >
        <img src="images/Suman 20180731_160604.jpg" height="200" alt=""><img src="images/Capture.PNG" height="200"  alt="">
        <img src="images/ani.jpg" height="200" alt=""><img src="images/Capture2.PNG"  height="200" alt=""></marquee>
