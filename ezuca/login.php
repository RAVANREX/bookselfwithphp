        ...
        <p>
          ...
          <img border="0" alt="London Rubber Stamp Logo" src="images/a1.jpg" width="100%" height="auto">
                    ...
                    <h1 align="center">LOG IN</h1>
                        ...
                        <h1 class="text-danger" align="center">&nbsp;<?php if(isset($_GET['msg'])){ echo $_GET['msg'];} ?></h1>
                        
                        
                        <form name="login" method="post" action="login_code.php"  >
                          <table cellpadding="15" align="center">
                            <tr>
                  <td><b><u><h3>Email Id </h3></u></b></td>
                  <td><input type="email" name="email" placeholder="Enter Email Id" required></td>
                </tr>
                <tr><td><b><u><h3>Password</h3></u></b></td>
                  <td><input type="password" name="pass" placeholder="Enter Password" required></td>
<td><input type="submit" name="login" value="LOG IN" class="btn btn-primary btn-block"></td><td></td></tr>
<tr><td>&nbsp;</td>
  <td align="center"><a href="forget.php"><b><font color="skyblue">Forgot Password?</font></b></a>
 </td>
</tr>
<tr><td>&nbsp;</td>
  <td  align="center"><a href="registration.php"><b><font color="skyblue">New Here<br>Sign Up</font></b></a>
 </td>
</tr>
                </table>
                </form>
