...
<body class="fixed-nav sticky-footer bg-light" id="page-top">
	<h1 align="center">Suspend-doc</h1>
...
user ON user.uid=document.uid WHERE `status`=2";
...
?><?php
		...
		<td align="center"><a href="1.php?appid=<?php echo $rec['appid'];?>" >APPROVE</a>
		</td>
		</tr><?php
		    }
		    if (isset($_GET['msg'])){
